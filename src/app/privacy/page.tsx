        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-6 text-slate-300">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li><strong>Email address:</strong> Required for purchase and delivery of your setup file.</li>
              <li><strong>Name:</strong> Optional, used only for personalization of your workout instructions.</li>
              <li><strong>Preferences:</strong> Your answers to the questionnaire (equipment, goals, etc.) are used to generate your personalized setup file.</li>
              <li><strong>Payment information:</strong> Processed securely by Polar; we do not store your payment details.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li><strong>Polar:</strong> Payment processing. See their privacy policy at polar.sh.</li>
              <li><strong>Vercel:</strong> Website hosting. See their privacy policy at vercel.com.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">5. Cookies and Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mt-8 mb-4">6. Data Sharing</h2>
            <p>
